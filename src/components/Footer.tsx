  ...
  return (
    <footer className="safe-bottom bg-[#525A43] text-stone-100 pt-12 sm:pt-16 pb-6 sm:pb-8 border-t-4 border-[#A1A696]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 pb-8 sm:pb-12 border-b border-[#3F4633]">
          <div className="flex items-center gap-3 sm:gap-4 bg-[#3F4633]/60 p-3 sm:p-4 rounded-xl border border-[#A1A696]/20">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-[#A1A696]/20 text-[#A1A696] flex items-center justify-center shrink-0 border border-[#A1A696]/30">
              <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div className="min-w-0">
              <h4 className="font-semibold text-white text-xs sm:text-sm">100% Pure Unani Herbs</h4>
              <p className="text-[10px] sm:text-xs text-[#A1A696] line-clamp-2">Formulated according to authentic classical Tib-e-Nabvi literature.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 bg-[#3F4633]/60 p-3 sm:p-4 rounded-xl border border-[#A1A696]/20">
            ...
            <div className="min-w-0">
              <h4 className="font-semibold text-white text-xs sm:text-sm">Nationwide Express Delivery</h4>
              <p className="text-[10px] sm:text-xs text-[#A1A696] line-clamp-2">Delivered directly to your doorstep with Cash on Delivery (COD).</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 bg-[#3F4633]/60 p-3 sm:p-4 rounded-xl border border-[#A1A696]/20">
            ...
            <div className="min-w-0">
              <h4 className="font-semibold text-white text-xs sm:text-sm">Qualified Hakeem Guidance</h4>
              <p className="text-[10px] sm:text-xs text-[#A1A696] line-clamp-2">Personalized consultation for your Mizaj and health conditions.</p>
            </div>
          </div>
        </div>

        {/* Links Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-10 py-8 sm:py-12">
          
          {/* Brand Info */}
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#525A43] flex items-center justify-center border-2 border-[#A1A696] overflow-hidden shrink-0">
              ...
              <span className="text-xl sm:text-2xl font-bold font-serif text-white tracking-tight">
            ...
            <div className="p-2 sm:p-2.5 rounded-lg bg-[#3F4633] border border-[#A1A696]/30 text-[10px] sm:text-[11px] space-y-1">
              <div className="flex items-center gap-1.5 text-white font-bold">
                <ShieldCheck className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#A1A696]" />
                <span>Official Government Registrations</span>
              </div>
              <div className="text-stone-200 font-mono text-[9px] sm:text-[10px]">
            ...
            <div className="pt-2 flex items-center gap-2">
              <span className="text-[#A1A696] font-serif text-xs sm:text-sm">شفاء من اللہ</span>
              <span className="text-stone-300 text-[10px] sm:text-xs">— Health is from Allah</span>
            </div>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-[#A1A696] font-bold text-xs sm:text-sm uppercase tracking-wider mb-3 sm:mb-4 border-b border-[#3F4633] pb-2">
              Quick Navigation
            </h3>
            <ul className="space-y-2 sm:space-y-2.5 text-[11px] sm:text-xs text-stone-200">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-3 text-[11px] sm:text-xs text-stone-200">
              ...
              <li className="flex items-center gap-2 sm:gap-2.5">
                <Mail className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#A1A696] shrink-0" />
                <a href="mailto:rafaishifakhana122@gmail.com" className="hover:text-[#A1A696] transition-colors break-all">rafaishifakhana122@gmail.com</a>
              </li>
            </ul>
            <div className="mt-4 sm:mt-5 p-2.5 sm:p-3 rounded-lg bg-[#3F4633] border border-[#A1A696]/30 text-[11px] sm:text-xs text-stone-200">
        ...
        <div className="pt-6 sm:pt-8 border-t border-[#3F4633] flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-[10px] sm:text-xs text-stone-300 text-center md:text-left">
          <p>© {new Date().getFullYear()} RafaiShifa Tib & Herbal Medicine Store. All rights reserved.</p>
          <p className="max-w-md text-[10px] sm:text-[11px] text-stone-300/80">
